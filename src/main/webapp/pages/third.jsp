    ...
    <div class="container">
      <div class="left">
        ...
        <div class="option flex">
          <img src="../images/airpods 3rd gen.jpg" onclick="img('../images/airpods 3rd gen.jpg')">
          <img src="../images/3p1.png" onclick="img('../images/3p1.png')">
          <img src="../images/3p2.png" onclick="img('../images/3p2.png')">
          <img src="../images/3p3.png" onclick="img('../images/3p3.png')">
      ...
      <div class="right">
        ...
        <p>It is magic, remastered. 
Introducing the all-new AirPods. Featuring spatial audio that places sound all around you, Adaptive EQ that tunes music to your ears, and longer battery life. It is all sweat and water resistant and delivers an experience that is simply magical. </p>
